...
export default class Level3 {
  ...
  start() {
    ...
    this.game.addGround(new BABYLON.Vector3(100, 100, 2), 0, 0.5, floorTex, floorTex, 3, () => {
      this.game.addBox(new BABYLON.Vector3(10, 10, 1), new BABYLON.Vector3(0, 3, -20), 0.25, 1, 0, crateTex);
      ...
      this.game.addBox(new BABYLON.Vector3(6, 5, 0.5), new BABYLON.Vector3(0, 10, -20), 0.25, 0.5, 0.5, crateTex);
      this.game.addGoalBox(new BABYLON.Vector3(0, 6, -20));
