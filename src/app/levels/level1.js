...
export default class Level1 {
  ...
  start() {
    this.game.addGround(new BABYLON.Vector3(100, 100, 100), 0, 0.5, '../../assets/img/level1/floor.png', '../../assets/img/level1/floor.png', 2);
    ...
    this.game.addSphere(new BABYLON.Vector3(0, 10, -40), 2, 2, 0, 0.5);
  }
}
